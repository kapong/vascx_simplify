...
def main():
    ...
    axes[0].scatter(
        fovea_x, fovea_y, c="red", s=200, marker="x", linewidths=3, label="Detected Fovea"
    )
    axes[0].scatter(
        fovea_x, fovea_y, c="red", s=800, facecolors="none", edgecolors="red", linewidths=2
    )
    ...
    axes[1].scatter(
        marker_x, marker_y, c="red", s=200, marker="x", linewidths=3, label="Fovea Center"
    )
    axes[1].scatter(
        marker_x, marker_y, c="red", s=800, facecolors="none", edgecolors="red", linewidths=2
    )
    ...
    ax.imshow(rgb_image)
    ax.scatter(
        prediction[0, 0, 0].cpu(),
        prediction[0, 0, 1].cpu(),
        c="yellow",
        s=300,
        marker="*",
        edgecolors="red",
